...
public class Laplacian extends Sharpening {
	...
	public Laplacian(int type) {
		switch (type) {
		case 0:
			int[] template0 = { 0, -1, 0, -1, 4, -1, 0, -1, 0, };
			template = template0;
			break;
		case 1:
			int[] template1 = { -1, -1, -1, -1, 8, -1, -1, -1, -1, };
			template = template1;
			break;
		case 2:
			int[] template2 = { 1, -2, 1, -2, 4, -2, 1, -2, 1, };
			template = template2;
			break;
		case 3:
			int[] template3 = { 0, -1, 0, -1, 5, -1, 0, -1, 0, };
			template = template3;
			break;
		case 4:
			int[] template4 = { -1, -1, -1, -1, 9, -1, -1, -1, -1, };
			template = template4;
			break;
		default:
			System.out
					.println("the type is wrong! please set type from 0 to 4.");
		}
	}
