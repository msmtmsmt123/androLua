...
public class LuaThread extends Thread implements Runnable, LuaMetaTable,
		LuaGcable {
	...
	public LuaThread(LuaContext luaContext, String src, boolean isLoop,
			Object[] arg) throws LuaException {
	...
	public LuaThread(LuaContext luaContext, LuaObject func, Object[] arg)
			throws LuaException {
		this(luaContext, func, false, arg);
	}

	public LuaThread(LuaContext luaContext, LuaObject func, boolean isLoop)
			throws LuaException {
	...
	private void initLua() throws LuaException {
		...
		if (mLuaContext instanceof Activity) {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				newLuaThread(data.getString("data"),
						(Object[]) data.getSerializable("args"));
				break;
			case 1:
			...
			case 3:
				...
				break;
			case 4:
				setField(data.getString("data"),
						((Object[]) data.getSerializable("args"))[0]);
				break;
			}
		}
	};
